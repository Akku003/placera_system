...
const CreateJob = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            submitData.append('package_lpa', parseFloat(formData.package_lpa));
            ...
            submitData.append('skills', JSON.stringify(skillsArray));  // SEND AS JSON STRING
                        ...
                        <div className="flex flex-wrap gap-2">
                            {branches.map(branch => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg border transition-colors ${formData.allowed_branches.includes(branch)
